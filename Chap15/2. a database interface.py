...
class bwDB:
    def __init__(self, **kwargs):
        # Doc string --> first line of any function/method/class etc to serrve as documentation (triple quote traditionally)
        """
    ...
    def sql_do(self, sql, params=()):           # sql_do for non-select queries
        """
    ...
    def sql_query(self, sql, params=()):        # Pass sql statement to execute then return generator to use in for loop
        """
    ...
    def sql_query_row(self, sql, params=()):    # query single row
        """
    ...
    def sql_query_value(self, sql, params=()):  # query single value
        """
            db.sql_query_row( sql[, params] )
    ...
    # filename property
    @property                           # For reading file name
    def _filename(self):
        return self._dbfilename

    @_filename.setter                   # Assigining value to file name (fresh database connect)
    def _filename(self, fn):
        self._dbfilename = fn
        self._db = sqlite3.connect(fn)
        self._db.row_factory = sqlite3.Row

    @_filename.deleter                  # Deleting file name
    def _filename(self):
        self.close()
